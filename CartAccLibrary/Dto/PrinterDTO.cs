...
namespace CartAccLibrary.Dto
{
    ...
    /// DTO класс принтера.
    /// </summary>
    public class PrinterDTO : BaseVm, IValidatableObject
    {
        private string model;
        private ObservableCollection<CartridgeDTO> compatibility;
        private bool inUse;
        ...
        /// </summary>
        public ObservableCollection<CartridgeDTO> Compatibility
        {
        ...
        /// <param name="compatibility">Совместимые картриджи</param>
        /// <param name="inUse">Статус использования</param>
        public PrinterDTO(int id, string model, ObservableCollection<CartridgeDTO> compatibility, bool inUse = true)
        {
            Id = id;
            Model = model;
